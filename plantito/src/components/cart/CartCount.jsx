...
import {ChevronDoubleLeftIcon,ArchiveBoxXMarkIcon} from '@heroicons/react/24/solid';
        ...
        <div className='bg-white h-11 flex items-center justify-between px-3 sticky top-0 left-0 right-0 w-full'>
            <div className='flex items-center gap-3'>
                <div className='grid items-center cursor-pointer' onClick={onCartToggle}>
                    <ChevronDoubleLeftIcon className='w-5 h-5 text-slate-900 hover:text-green-500 stroke-[2]'/>
                </div>
