  ...
  return (
    <>
        <div className='bg-white flex items-center justify-center flex-col h-screen px-11 text-center gap-7'>
            ...
            <button type='button' className='buttom-theme bg-gradient-to-b from-green-400 to-green-500 shadow-lg shadow-green-400 flex items-center justify-center text-slate-900 py-2 gap-3 text-sm px-5 font-semibold active:scale-110'>
