...
const Item = ({id, color,shadow,title,text,img,btn,price }) => {
  return (
   <>
        ...
        <div className={`relative bg-gradient-to-b ${color} grid items-center justify-items-center rounded-xl py-4 px-5 transition-all duration-700 ease-in-out w-full hover:scale-105`}>
            ...
            <div className='flex items-center mt-2'>
                <img src={img} alt="product" className='h-36 w-64 transition-theme hover:-rotate-12' />
            </div>
        </div>
